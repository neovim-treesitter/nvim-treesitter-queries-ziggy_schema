# nvim-treesitter-queries-ziggy_schema

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ziggy_schema/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ziggy_schema/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ziggy_schema**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ziggy_schema",
...
- [ ] Changes are scoped to `ziggy_schema` — do not include files for other languages
